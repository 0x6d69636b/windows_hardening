Function Invoke-HardeningKitty {
    ...
    .PARAMETER Quiet
        ...
        Option to disable all output generated by the script.

    .PARAMETER QuietOption

        Define type of the quiet mode. It can be 
            - '1' : for a soft quiet mode
    ...
    Function Write-ProtocolEntry {
        ...
        if (-not($Quiet) -or $QuietOption -eq '1') {
            Switch ($LogLevel) {
            ...
            Switch ($LogLevel) {
                ...
                "Raw"  { $Message = $Text; Write-Host -ForegroundColor Gray $Message; Break }
    ...
    If ($Quiet -and $QuietOption.Length -eq 0) {
        $QuietOption = '2'
    }
    ...
    # Header
    #
    Write-ProtocolEntry -Text "`n" -LogLevel "Raw"
    Write-Output "      =^._.^="
